...
import com.github.ccguyka.showupdates.ArtifactBuilder.Companion.aManagedDependency
...
import com.github.ccguyka.showupdates.DependencyManagementBuilder.from
...
class ShowDependencyManagementUpdatesMojoTest : AbstractMojoTestCase() {
    ...
    fun testExcludeBlacklistedUpdates() {
        ...
        mojo!!.execute()
        Mockito.verify(log)?.info("Available dependency management updates:")
        Mockito.verify(log)?.info("  dep-mgnt-groupId:dep-mgnt-artifactId ... 1.1.1 -> 1.2.0")
    ...
    fun testMajorUpdates() {
        ...
        mojo!!.execute()
        Mockito.verify(log)?.info("Available dependency management updates:")
        Mockito.verify(log)?.info("  dep-mgnt-groupId:dep-mgnt-artifactId ... 1.1.1 -> 2.2.0")
        Mockito.verifyNoMoreInteractions(log)
    }
    ...
    fun testPatchUpdates() {
        ...
        mojo!!.execute()
        Mockito.verify(log)?.info("Available dependency management updates:")
        Mockito.verify(log)?.info("  dep-mgnt-groupId:dep-mgnt-artifactId ... 1.1.1 -> 1.1.3")
        Mockito.verifyNoMoreInteractions(log)
    }
    ...
    fun testLatestUpdates() {
        ...
        mojo!!.execute()
        Mockito.verify(log)?.info("Available dependency management updates:")
        Mockito.verify(log)?.info("  dep-mgnt-groupId:dep-mgnt-artifactId ... 1.1.1 -> 1.1.3, 1.2.0, 2.2.0")
        Mockito.verifyNoMoreInteractions(log)
    }
