...
image:https://img.shields.io/github/last-commit/ccguyka/show-updates-maven-plugin?style=flat-square[GitHub last commit]
image:https://img.shields.io/snyk/vulnerabilities/github/ccguyka/show-updates-maven-plugin?style=flat-square[Snyk Vulnerabilities for GitHub Repo]
